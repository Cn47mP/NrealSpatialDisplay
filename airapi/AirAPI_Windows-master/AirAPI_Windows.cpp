...
//Nreal Light USB VID and PID
#define LIGHT_VID 0x04d2
#define LIGHT_PID 0x162f
...
static hid_device_info* open_device()
{
	...
	struct hid_device_info* devs_light = hid_enumerate(LIGHT_VID, LIGHT_PID);
